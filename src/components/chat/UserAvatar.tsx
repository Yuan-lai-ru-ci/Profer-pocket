/**
 * UserAvatar - 用户头像组件（apps/tablet-client）
 *
 * 对齐桌面 components/chat/UserAvatar.tsx（原样搬，无 IPC）：
 *  - 支持 emoji 字符串（直接渲染文字）
...
export function UserAvatar({ avatar, size = 35, className, onClick }: UserAvatarProps): React.ReactElement {
