/**
 * ChatToolBlock — 移动端 Chat 模式工具调用块（apps/tablet-client）
 *
 * 对齐桌面 components/chat/ChatToolBlock.tsx 的视觉，但删去 PreviewOpenButton
 * （桌面 Electron 文件预览，移动端不搬，红线约束）。依赖已迁移的
 * getToolIcon / getToolPhrase / ToolResultRenderer（均为移动端极简版）。
 */
