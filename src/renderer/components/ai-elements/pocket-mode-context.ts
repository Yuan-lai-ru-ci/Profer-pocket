...
export const PocketModeContext = React.createContext(false)

export function usePocketMode(): boolean {
  return React.useContext(PocketModeContext)
}
