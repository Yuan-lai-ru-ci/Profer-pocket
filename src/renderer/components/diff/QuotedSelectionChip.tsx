 ...
 * 点击 X 按钮可移除。
 *
 * 来源：ProferAI `origin/main:apps/electron/src/renderer/components/diff/QuotedSelectionChip.tsx`
 * （PB-7，逐字取桌面主干版本；pocket 此前是 pre-variant 版，props 仅 text/filePath/onRemove/className）
 */
